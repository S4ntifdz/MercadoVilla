...
SECRET_KEY = 'django-insecure-k=_c!pm(+lp!4xxegzycbkvpi&1yno5%z5h(gs8j82$p+ag=q#'
...
JAZZMIN_SETTINGS = {
    ...
    "welcome_sign": "Aqui ingresara al panel de administracion",
